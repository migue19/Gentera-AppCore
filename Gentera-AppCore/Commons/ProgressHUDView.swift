...
//  Gentera-AppCore
//
//  Created by Miguel Mexicano Herrera on 07/12/25.
//
import UIKit
import Lottie
...
public final class ProgressHUDView: UIView {
    ...
    public convenience init() {
        self.init(animationName: "loader-run", loaderSize: 100, blurStyle: .dark, dimAlpha: 0.2)
    }

    public init(animationName: String = "loader-run",
